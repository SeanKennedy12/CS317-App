...
if(!mysql_fetch_array($query)){
	mysql_query('INSERT INTO markers (lat, lng, username) VALUES ('.$_POST['lat'].', '.$_POST['lng'].', "'.$_POST['username'].'");'); 
	echo('Inserted '.$_POST['lat'].' and '.$_POST['lng'].' into table under username <'.$_POST['username'].'>');
}else{
